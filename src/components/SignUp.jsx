  ...
  const onSubmit = async (data) => {
    ...
    if (isRegister) {
      if (accountType === "seeker") {
        // URL = "user/register";
        //URL = "http://posts.com:8800/api-v1/users/register";
         URL = "http://posts.com/api-v1/users/register";

      } else {
        // URL = "companies/register";
        // URL = "http://posts.com:8802/api-v1/companies/register";
        URL = "http://posts.com/company/api-v1/companies/register";

      }
    } else {
      if (accountType === "seeker") {
        // URL = "user/login";
        //URL = "http://posts.com:8800/api-v1/users/login";
        URL = "http://posts.com/api-v1/users/login";

      } else {
        //URL = "http://posts.com:8802/api-v1/companies/login";
        URL = "http://posts.com/company/api-v1/companies/login";
