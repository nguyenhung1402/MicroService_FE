  ...
  const onSubmit = async (data) => {
    ...
    try {
      const res = await apiRequest({
        ...
        // url: "http://posts.com:8802/api-v1/companies/update-company",        
        url: "http://posts.com/company/api-v1/companies/update-company",
        token: user?.token,
        data: newData,
        method: "PUT",
      });
  ...
  const fetchCompany = async () => {
    ...
    try {
      const res = await apiRequest({
        ...
        url: "http://posts.com/company/api-v1/companies/get-company/" + id,
        method: "GET",
      });
